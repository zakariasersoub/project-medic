...
// تأكد أن معرف المريض موجود في الجلسة
                  ...
                  while ($row = $result->fetch_assoc()) {
                      ...
                      <article class="appointment-card">
                        <div class="appointment-details">
                          ...
                          <h3 class="doctor-name mt-2">Dr. ' . htmlspecialchars($row['doctor_name']) . '</h3>
                        ...
                        <div class="appointment-actions mt-2">
                          <a style="  text-decoration: none;" class="btn-cancel btn btn-danger btn-md me-2" style="font-size: 1.1rem; padding: 0.6rem 1.2rem;" href="cancel.php?id=' . $row['id'] . '">
                          <img src="images/x.svg" alt="Cancel" class="action-icon" width="15" height="15" /> Cancel
                          </a>
                          <a style="  text-decoration: none;" class="btn-reschedule btn btn-primary btn-md" style="font-size: 1.1rem; padding: 0.6rem 1.2rem;" href="reschedule.php?id=' . $row['id'] . '">
