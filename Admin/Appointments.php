...
<html lang="en">
  ...
  <body>
          ...
          <ul class="nav-list">
            ...
            <!-- <li>
              <a href="notifications.php" class="nav-link">
                <img src="images/not.svg" alt="notifications" class="nav-icon" style="width: 17px" />
      ...
      <main class="main-content">
       ...
       <div class="content-controls">
          <div class="search-container">
            ...
            <input type="text" placeholder="Search Appointments..." class="search-input" id="appointmentSearchInput" onkeyup="filterAppointments()" autocomplete="off">
          </div>
          <div class="action-buttons">
            <form id="appointmentFilterForm" style="display:inline;">
              <select name="status" class="form-select" id="statusSelect" onchange="filterAppointments()" style="padding: 11px 17px; border-radius: 8px; border: 1px solid #e5e7eb; background-color: transparent; font-size: 16px; font-weight: 600; color: #1e293b;">
            ...
            <button class="add-btn">
              <a href="/medic/admin/create-appointment.php" style ="color: white; text-decoration: none;">
    ...
    <iframe id="appointmentsFrame" src="bootstrap-section-appointments.php" style="width:100%; height:600px; border:none;"></iframe>

        <script>
        function filterAppointments() {
          var input = document.getElementById('appointmentSearchInput').value;
          var status = document.getElementById('statusSelect').value;
          var frame = document.getElementById('appointmentsFrame');
          var url = 'bootstrap-section-appointments.php?search=' + encodeURIComponent(input);
